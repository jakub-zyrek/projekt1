...
<script>
    ...
    // przycisk nie wysyła zapytań gdy nie zalogowany
                ...
                while ($w2 = mysqli_fetch_array($wysz2)) {
                  ...
                  echo '<div class="col">';
                    echo '<div class="card mb-4 rounded-3 shadow-sm" id="o'.$w2['id'].'">';
                      ...
                      echo '</div>';
                      echo '<div class="card-footer py-2 text-start">
                      <div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 3%;"> <button';
                      ...
                      echo ' type="button" onclick="dzieki('."'o".$id."'".', '."'serce".$id."'".');" onmouseover="dzie('."'serce".$id."'".');" onmouseout="dziek('."'serce".$id."'".')" id="serce'.$id.'" class="btn btn-lg btn-outline-danger" style="display: flex; margin: auto; justify-content: center; align-items: center; font-size: 1rem; margin-bottom: 2%; margin-top: 2%; flex-grow: 1;">
                        ...
                        <button onclick="coment('.$id.');" type="button" class="btn btn-lg btn-outline-dark"  style="display: flex; margin: auto; justify-content: center; align-items: center; font-size: 1rem; margin-bottom: 2%; margin-top: 2%; flex-grow: 1;">
                          <svg xmlns="http://www.w3.org/2000/svg" style="width: 1rem;" fill="currentColor" class="bi bi-chat-left-text-fill" viewBox="0 0 16 16">
                            <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4.414a1 1 0 0 0-.707.293L.854 15.146A.5.5 0 0 1 0 14.793V2zm3.5 1a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 2.5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 2.5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5z"/>
                          </svg>
                          &nbsp;<span id="komet'.$id.'">Wyświetl komentarze</span>
                        </button>
                      ...
                      <div class="card-body col-12 col-md-10" id="com'.$id.'" style="margin-left: auto; transition: 2s ease; overflow: scroll; display: block;">
