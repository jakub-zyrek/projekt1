...
<html lang="pl">
  <head>
    ...
    <title>Forum internetowe | Cennik</title>
        ...
        <div class="col">
          <div class="card mb-4 rounded-3 shadow-sm">
            ...
            <div class="card-body">
              ...
              <a class="w-100 btn btn-lg btn-warning" href="kupowanie.php?plan=1">Kup</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card mb-4 rounded-3 shadow-sm border-warning">
            ...
            <div class="card-body">
              ...
              <a class="w-100 btn btn-lg btn-warning" href="kupowanie.php?plan=2">Kup</a>
            </div>
          </div>
        </div>
      </div>
