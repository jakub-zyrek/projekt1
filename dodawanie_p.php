...
// Sprawdzenie czy jest zalogowany i czy nie jest zabnowany
...
// Wprowadzenie kategorii do tablicy
        ...
        <div class="card-body">
          <form action="script_PHP/dodawanie_p.php" method="post" class="needs-validation" style="display: flex; flex-wrap: wrap;justify-content: space-between;" novalidate>
            ...
            <div style="display: flex; flex-wrap: nowrap; align-items: start;" class="col-12 mt-3">
              ...
              <button type="submit" class="btn btn-outline-info mt-3 col-12" style="display: flex; flex-wrap: nowrap; align-items: center;justify-content: center;">Dodaj pytanie&nbsp;&nbsp;
