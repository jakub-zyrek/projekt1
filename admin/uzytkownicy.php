...
<body class="col-12 bg-dark" style="display: flex; ">
    <main class="d-flex flex-nowrap" id="e">
        ...
        <main class="col-10 " style="background-color: gainsboro;">
            ...
            <div class="col-11 d-none d-md-inline" style="display: flex; flex-wrap: wrap; justify-content: center; align-items: start; ">
                    ...
                    <div class="ps-3 pb-2">
                        <table class="table col-12 table-hover">
                            ...
                            <tr>
                                <td>1.</td>
                                <td>Jakub Żyrek</td>
                                <td class="text-success">Ekspert</td>
                                <td class="text-warning">TAK</td>
                                <td>4,5</td>
                                <td>1</td>
                                <td style="display: flex; align-items: center; justify-content: space-evenly; flex-wrap: nowrap;">
                                    <button type="button" class="btn btn-outline-danger" style="display: flex; align-items: center; justify-content: start; flex-wrap: nowrap;">
