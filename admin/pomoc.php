...
<head>
    ...
    <title>Panel administratora | Zarządzanie zakładką pomocy</title>
  ...
  <body class="col-12 bg-dark" style="display: flex;">
    <main class="d-flex flex-nowrap">
      <div class="p-3 text-bg-dark col-12" >
        ...
        <nav class="nav col-12 col-xxl-12 text-center text-xl-start">
          ...
          <a href="pomoc.php" class="nav-item btn btn-danger text-xxl-start text-white col-10 p-2 rounded-2 mt-3 align-items-center align-self-center">
            <svg xmlns="http://www.w3.org/2000/svg" style="width: 1.5rem;" fill="currentColor" class="bi bi-clipboard-x-fill" viewBox="0 0 16 16">
              <path d="M6.5 0A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3Zm3 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3Z"/>
              <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1A2.5 2.5 0 0 1 9.5 5h-3A2.5 2.5 0 0 1 4 2.5v-1Zm4 7.793 1.146-1.147a.5.5 0 1 1 .708.708L8.707 10l1.147 1.146a.5.5 0 0 1-.708.708L8 10.707l-1.146 1.147a.5.5 0 0 1-.708-.708L7.293 10 6.146 8.854a.5.5 0 1 1 .708-.708L8 9.293Z"/>
            </svg>
    ...
    <main class="col-10" style="background-color: gainsboro;">
      ...
      <div class="col-11" style="display: flex; flex-wrap: wrap; justify-content: center; align-items: start; ">  
        <div class="col-11 d-none d-md-table-row m-3 bg-white p-2">
            ...
            <div class="ps-3 pb-2">
                <div class="p-1" style="font-size: 1.5rem;">
                    <table class="col-12">
                      <tr>
                        <td class="col-2">Pytanie:</td>
                        <td><input type="text" name="pytanie" id="pytanie" class="form-control"></td>
                      </tr>
                      <tr>
                        <td>Odpowiedź</td>
                        <td><textarea name="odpowiedz" id="odpowiedz" class="form-control" rows="3"></textarea></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2">
                          <button type="button" class="btn btn-success w-100" onclick="pomoc_d();">Dodaj pytanie</button>
                        </td>
                      </tr>
                    </table>
                </div>
        ...
        <div class="col-11 d-none d-md-table-row m-3 bg-white p-2">
            ...
            <hr>
            <div class="ps-3 pb-2">
              <form action="script/instrukcje.php" method="POST" ENCTYPE="multipart/form-data">
                <div class="p-1" style="font-size: 1.5rem;">
                    <table class="col-12">
                      <tr>
                        <td class="col-2">Tytuł:</td>
                        <td><input type="text" name="pytanie" id="pytanie" class="form-control"></td>
                      </tr>
                      <tr>
                        <td>Plik</td>
                        <td><input type="file" name="zw" id="plik" class="form-control"></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2">
                          <button type="submit" class="btn btn-success w-100">Dodaj instrukcje</button>
                        </td>
                      </tr>
                    </table>
                </div>
            ...
            <table class="table col-12 table-hover">
              ...
              <?php
                ...
                while ($w = mysqli_fetch_array($wysz)) {
                  ...
                  echo "<td>$i.</td>";
                  echo "<td>".$w['tytul']."</td>";
                  echo "<td><a href='../".$w['plik']."'>Odtwórz</a></td>";
                  echo "<td><a class='btn btn-danger' href='script/usuwanie_i.php?id=".$w['id']."'>Usuń</a></td>";
                  echo "</tr>";
                  $i++;
                }
    ...
    <script>
      ...
      function pomoc_w() {
        plik = 'script/lista_pomoc.php?pomo=' + pomo;
      ...
      function pomoc_u(id) {
        plik2 = 'script/lista_u.php?id=' + id;
        xml2 = null;
        try {
      ...
      function pomoc_d() {
        pyt = document.getElementById("pytanie").value;
        opinie = document.getElementById("odpowiedz");
        opinie.value = opinie.value.replaceAll("+", '%2B');
        opinie.value = opinie.value.replaceAll("!", '%21');
        opinie.value = opinie.value.replaceAll("#", '%23');
        opinie.value = opinie.value.replaceAll("$", '%24');
        ...
        opinie.value = opinie.value.replaceAll("*", '%2A');
        opinie.value = opinie.value.replaceAll(",", '%2B');
        plik2 = 'script/pomoc_dod.php?pytanie=' + pyt + "&odp=" + opinie.value;
        xml2 = null;
        try {
          xml2 = new ActiveXObject("Microsoft.XMLHTTP"); // IE
        } catch (e) {
