            ...
            <div class="col-11" style="display: flex; flex-wrap: wrap; justify-content: center; align-items: start; ">
                ...
                <div class="col-10 col-lg-6 col-xl-7 m-3 bg-white p-2">
                    ...
                    <div class="ps-3 pb-2">
                        ...
                        <p class="col-12 text-center">Dodanych postów</p>
                ...
                <div class="m-3 col-11 bg-white p-2">
                    ...
                    <hr>
                    <div class="ps-3 pb-2">
                        <div class="p-1" style="display: flex; align-items: center; cursor: pointer; justify-content: left; width: 100%; text-align: left;">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" style="width: 3.5rem;" fill="currentColor" class="bi bi-envelope-exclamation" viewBox="0 0 16 16">
                                    <path d="M2 2a2 2 0 0 0-2 2v8.01A2 2 0 0 0 2 14h5.5a.5.5 0 0 0 0-1H2a1 1 0 0 1-.966-.741l5.64-3.471L8 9.583l7-4.2V8.5a.5.5 0 0 0 1 0V4a2 2 0 0 0-2-2H2Zm3.708 6.208L1 11.105V5.383l4.708 2.825ZM1 4.217V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v.217l-7 4.2-7-4.2Z"/>
                                    <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.5-5v1.5a.5.5 0 0 1-1 0V11a.5.5 0 0 1 1 0Zm0 3a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z"/>
                                  </svg>
                            </div>
                            <div class="ms-4">
                                <div><b>Jakub Żyrek</b></div>
                                <div><i>Blalansakdasubdiasdi</i></div>
                            </div>
                        </div>
                        <div class="p-1" style="display: flex; align-items: center; cursor: pointer; justify-content: left; width: 100%; text-align: left;">
                            <div>
