    ...
    <main class="d-flex flex-nowrap">
      <div class="p-3 text-bg-dark col-12" >
        ...
        <nav class="nav col-12 col-xxl-12 text-center text-xl-start">
          <a href="index.php" class="nav-item btn btn-primary text-xxl-start text-white col-10 p-2 rounded-2 mt-3 align-items-center align-self-center">
          ...
          <a href="statystyki.php" class="nav-item btn btn-outline-primary text-xxl-start text-white col-10 p-2 rounded-2 mt-3 align-items-center align-self-center">
