...
<head>
  ...
  <body class="col-12 bg-dark" style="display: flex;">
    <main class="d-flex flex-nowrap">
      <div class="p-3 text-bg-dark col-12" >
        ...
        <nav class="nav col-12 col-xxl-12 text-center text-xl-start">
          ...
          <a href="zarobki.php" class="nav-item btn btn-success text-xxl-start text-white col-10 p-2 rounded-2 mt-3 align-items-center align-self-center">
    ...
    <script>
      ...
      function pyt_w() {
        plik3 = 'script/zakup_w.php?zakup=' + zakup;
