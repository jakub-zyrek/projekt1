    ...
    <main class="d-flex flex-nowrap" id="e">
        ...
        <div class="p-3 text-bg-dark col-12">
          ...
          <nav class="nav col-12 col-xxl-12 text-center text-xl-start">
            ...
            <div class="nav-item btn btn-danger text-xl-start text-white col-10 p-2 rounded-2 mt-3 align-items-center align-self-center">
                        ...
                        <table class="table col-12 table-hover">
                            ...
                            <tr>
                                ...
                                <td style="width: min-content; text-align: center;">
                                    <button type="button" class="btn btn-outline-warning" onclick="document.getElementById('info').innerHTML = bycz; var a = document.getElementById('card'); document.getElementById('essa').style.top = (a.offsetTop + 20) + 'px';">
                                    Szczegóły
                                    </button>
                                    &nbsp;&nbsp;
                                    <button type="button" class="btn btn-outline-primary dropdown-toggle me-2 mb-3 mb-lg-auto " data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <li>
                                            <a class="dropdown-item" >
                                                Zbanuj użytkownika: Anna Gałwa
                                            </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="kategorie.php?kat=CSS">
                                                    Zignoruj zgłoszenie
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    Wyślij maila ostrzegaącego
                                                </a>
                                            </li>
                                        </ul>
                                    </button>
                            ...
                            <tr>
                                ...
                                <td>Pomoc</td>
                                <td style="width: min-content; text-align: center;">
                                    <button type="button" class="btn btn-outline-success" onclick="document.getElementById('info').innerHTML = byczz; var a = document.getElementById('card'); document.getElementById('essa').style.top = (a.offsetTop + 20) + 'px';">
                                    Odpisz
                                    </button>
                                </td>
                            </tr>
        ...
        <div id="info" style="position: absolute; margin: auto; width: 80%; left: 10%;">
